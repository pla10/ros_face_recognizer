...
#include <stddef.h>
#include "my_interfaces/msg/detail/student__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  my_interfaces__msg__Student__init(message_memory);
}

void Student__rosidl_typesupport_introspection_c__Student_fini_function(void * message_memory)
{
  my_interfaces__msg__Student__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Student__rosidl_typesupport_introspection_c__Student_message_member_array[3] = {
  {
    ...
    offsetof(my_interfaces__msg__Student, name),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_interfaces__msg__Student, surname),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_interfaces__msg__Student, score),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Student__rosidl_typesupport_introspection_c__Student_message_members = {
  ...
  3,  // number of fields
  sizeof(my_interfaces__msg__Student),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_interfaces, msg, Student)() {
